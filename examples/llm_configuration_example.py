...
async def main():
    ...
    print("\n=== Example Complete ===")
    print("\nTo use the enhanced CLI tools:")
    print("  # Show comprehensive system status")
    print("  uv run python -m src.utils.llm.cli status --detailed")
    print()
    print("  # Quick connectivity test")
    print("  uv run python -m src.utils.llm.cli quick-test")
    print()
    print("  # Monitor performance in real-time")
    print("  uv run python -m src.utils.llm.cli monitor --watch")
    print()
    print("  # List available models")
    print("  uv run python -m src.utils.llm.cli list-models")
    print()
    print("  # Set model preferences")
    print("  uv run python -m src.utils.llm.cli set-preference heavy gpt-5")
    print("  uv run python -m src.utils.llm.cli set-preference light gemma3n:e4b")
    print()
    print("  # Generate configuration template")
    print("  uv run python -m src.utils.llm.cli generate-env --output .env.example")
    print()
    print("  # Run comprehensive benchmark")
    print("  uv run python -m src.utils.llm.cli benchmark --iterations 5")
    print()
    print("  # Show all available commands")
